...
#[test]
fn test_alt_sort_8() {
	let a = f32x4::from_array([2.0, 1.0, 4.0, 3.0]);
	let b = f32x4::from_array([6.0, 5.0, 8.0, 7.0]);
	...
	let a = f32x8::from_array([2.0, 1.0, 4.0, 3.0, 6.0, 5.0, 8.0, 7.0]);
	let b = f32x8::from_array([6.0, 5.0, 8.0, 7.0, 2.0, 1.0, 4.0, 3.0]);
